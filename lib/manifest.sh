...
MANIFEST_STYLES=(
  ...
  "banner_cinema|style|🎬 CINEMA 影院黑金|4.8,4.9|原创: 21:9超宽画幅+上下黑边+胶片帧条+放映按钮 (6色可选)|components/home/banner_cinema|home|<link rel=\"stylesheet\" href=\"vanvy/banner_cinema/style.css\" type=\"text/css\" media=\"all\" />|<script src=\"vanvy/banner_cinema/tmdb-loader.js\"></script>|<script src=\"vanvy/banner_cinema/banner-cinema.js\"></script>|vanvy/banner_cinema/banner-cinema.js|"
...
# ─────────── 预热加载 Loading (可叠加, 独立于轮播) ───────────
MANIFEST_LOADING=(
  "loading_aurora|loading|🌌 AURORA 极光|all|极光粒子+光晕动画 (推荐搭配 AURORA 轮播)|components/loading/aurora|global|<link rel=\"stylesheet\" href=\"vanvy/loading/aurora/style.css\" type=\"text/css\" media=\"all\" />|<script src=\"vanvy/loading/loading.js\"></script>|<script>VanvyLoading && VanvyLoading.init('aurora');</script>|vanvy/loading/loading.js|"
  "loading_cinema|loading|🎬 CINEMA 影院|all|电影胶片卷轴+黑金配色 (推荐搭配 CINEMA 轮播)|components/loading/cinema|global|<link rel=\"stylesheet\" href=\"vanvy/loading/cinema/style.css\" type=\"text/css\" media=\"all\" />|<script src=\"vanvy/loading/loading.js\"></script>|<script>VanvyLoading && VanvyLoading.init('cinema');</script>|vanvy/loading/loading.js|"
  "loading_split|loading|📐 SPLIT 分屏|all|左右分屏+毛玻璃+网格光效 (推荐搭配 SPLIT 轮播)|components/loading/split|global|<link rel=\"stylesheet\" href=\"vanvy/loading/split/style.css\" type=\"text/css\" media=\"all\" />|<script src=\"vanvy/loading/loading.js\"></script>|<script>VanvyLoading && VanvyLoading.init('split');</script>|vanvy/loading/loading.js|"
  "loading_minimal|loading|⚪ MINIMAL 简约|all|细线动画+黑色背景+白色文字|components/loading/minimal|global|<link rel=\"stylesheet\" href=\"vanvy/loading/minimal/style.css\" type=\"text/css\" media=\"all\" />|<script src=\"vanvy/loading/loading.js\"></script>|<script>VanvyLoading && VanvyLoading.init('minimal');</script>|vanvy/loading/loading.js|"
  "loading_logo|loading|🖼️ LOGO 动态|all|品牌Logo动态展示+呼吸效果|components/loading/logo|global|<link rel=\"stylesheet\" href=\"vanvy/loading/logo/style.css\" type=\"text/css\" media=\"all\" />|<script src=\"vanvy/loading/loading.js\"></script>|<script>VanvyLoading && VanvyLoading.init('logo');</script>|vanvy/loading/loading.js|"
)
