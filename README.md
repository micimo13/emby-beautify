...
# 零交互快速安装（全家桶）
curl -sL https://gh-proxy.com/https://raw.githubusercontent.com/micimo13/emby-beautify/main/scripts/online-install.sh | bash -s -- --package full --yes

# 指定容器 + 指定组件
curl -sL https://gh-proxy.com/https://raw.githubusercontent.com/micimo13/emby-beautify/main/scripts/online-install.sh | bash -s -- --container emby --feature danmaku
```
