(function () {
  ...
  if (pic == "Banner") {
    ...
    query.EnableImageTypes = "Banner,Backdrop";
  ...
  async function init() {
    try {
      ...
      await getBackdropItems(apiClients, query)
        .then(function (e) {
          if (window.VanvyCarouselRules && window.VanvyCarouselRules.loaded) {
            e.Items = window.VanvyCarouselRules.applyPin(e.Items);
          }
          return e.Items;
        })
        .then(function (e) {
...
//     banners = document.querySelectorAll(".view:not(.hide) .homeSectionsContainer")[0];
//     banners01 = document.querySelectorAll(".view:not(.hide) .homeSectionsContainer .banners")[0];
//     if (banners && !banners01) {
//       play_status && pausedPlay();
//       init();
//     }
//   }, 1000);
